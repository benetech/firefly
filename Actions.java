...
public class Actions
{
	public Actions(MainWindow mainWindow)
	{
		...
		codeToJumpMenuActionMap = new HashMap<String, AbstractJumpMenuAction>();
                ...
                /* These will be uncommented at the end when the two respective
                 * files are complete and ready for use
                */
		//registerAction(new ActionDownloadProject(mainWindow));
                //registerAction(new ActionUploadProject(mainWindow));
